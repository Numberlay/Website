    ...
    <>
        <div className='mt-[2rem]'>
            <div className='mdx:hidden flex px-[2rem] py-[2rem] mt-[1rem] mx-[1.5vw] slg:mx-[5vw]'>
                ...
                <div className='w-[30vw] flex flex-col px-2'>
                    <div className='text-[2rem] font-[500]'><AnchorLink href="#ourServices">Our Services</AnchorLink></div>
                    ...
                    <div className='text-[0.98rem] slg:text-[1.1rem]'>
                        <ul>
                            <li><AnchorLink href="#bookKeeping" >Bookkeeping</AnchorLink></li>
                            <li><AnchorLink href="#accountPayable">Accounts payable</AnchorLink></li>
                            <li><AnchorLink href="#payrollManagement">Payroll Management</AnchorLink></li>
                            <li><AnchorLink href="#digitalRecordManagement">Digital Record Management</AnchorLink></li>
                            <li><AnchorLink href="#businessAccounting">Business Accounting Setup & Training</AnchorLink></li>
                        </ul>
                    </div>
                </div>
            ...
            <div className='md:hidden flex flex-col w-full '>
                ...
                <div className='flex flex-col px-[1.2rem] smd:px-[2.3rem] mt-[0.8rem]'>
                    ...
                    <div className='text-[1rem]  text-[#565656]'>
                        <ul>
                            <li><AnchorLink href="#bookKeeping1" >Bookkeeping</AnchorLink></li>
                            <li><AnchorLink href="#accountPayable1">Accounts payable</AnchorLink></li>
                            <li><AnchorLink href="#payrollManagement1">Payroll Management</AnchorLink></li>
                            <li><AnchorLink href="#digitalRecordManagement1">Digital Record Management</AnchorLink></li>
                            <li><AnchorLink href="#businessAccounting1">Business Accounting Setup & Training</AnchorLink></li>
                        </ul>
                    </div>
                </div>
            </div>
